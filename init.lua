...
require('lazy').setup({
  ...
  --
  --  Here are some example pugins that I've included in the Kickstart repository.
...
require('cmp').setup {
  mapping = {
    ['<C-Space>'] = require('cmp').mapping.complete(), -- Use Ctrl+Space to manually trigger completion
  },
}
